package com.ufinity.madoka.common.logging;
...
public class LogHelper {
	...
	/*
	 * private static Logger debug = Logger.getLogger("logdebug"); private
	 * static Logger error = Logger.getLogger("logerror"); private static Logger
	 * cron = Logger.getLogger("logcron");
	 */
	...
	private static String getMessage(Object message, int wrapLevel) {
		...
		if (stes.length < 3 + wrapLevel) {
			...
			String prefix = shortClassName + "." + target.getMethodName() + "(" + target.getFileName() + ":"
	 ...
	 * System.out.println(message); LogHelper.debug(message, 1); }
	 * 
	 ...
	 */
	/*
	 * public static void cron(Object message) { LogHelper.cron(message, 1); }
	 * 
	 * public static void cron(Object message, int wrapLevel) {
	 * LogHelper.cron.info(LogHelper.getMessage(message, wrapLevel)); }
	 */
	 ...
	 * System.out.println(message); LogHelper.error(message, 1); }
	 * 
	 ...
	 * LogHelper.error.info(LogHelper.getMessage(message, wrapLevel)); if (t ==
	 * null) { LogHelper.error.info("    null throwable passed......"); return;
	 * } StackTraceElement[] stes = t.getStackTrace(); for (int i = 0; i <
	 * stes.length; i++) { LogHelper.error.info("    at " + stes[i]); } }
	 */
}
